...
/***/ "./node_modules/moment/locale sync recursive [/\\\\](es(\\.js)?)$":
/*!***********************************************************!*\
  !*** ./node_modules/moment/locale sync [/\\](es(\.js)?)$ ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
webpackContext.id = "./node_modules/moment/locale sync recursive [/\\\\](es(\\.js)?)$";
...
function loadLocale(name) {
    ...
    if (!locales[name] && (typeof module !== 'undefined') &&
        ...
        try {
            ...
            __webpack_require__("./node_modules/moment/locale sync recursive [/\\\\](es(\\.js)?)$")("./" + name);
...
class Provider {
  ...
  getEvents() {
    ...
    return Promise.resolve(_models_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseEvents(fakePhotoEvents));
  }
  ...
  createEvent(event) {
    ...
    const localNewEvent = _models_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].clone(Object.assign(event, {id: localNewEventId}));
  ...
  updateEvent(id, event) {
    ...
    const localEvent = _models_event_js__WEBPACK_IMPORTED_MODULE_0__["default"].clone(Object.assign(event, {id}));
...
class Board extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    ...
    this._loadingElement = Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])(createLoadingMessage());
  }
  ...
  loadingStatusOn() {
    this.getElement().appendChild(this._loadingElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
  }
...
const generateTimeMarkup = (event) => {
  ...
  const dateTime = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getDateTime"])(eventDate);
  const monthDate = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getMonthDate"])(eventDate);
...
class Day extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
...
class DaysContainer extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/* harmony import */ var _models_event_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/event.js */ "./src/models/event.js");
...
const generateEventTypeElement = (eventType) => {
  const eventTypeTitle = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["makeFirstLetterUppercase"])(eventType);
  ...
  return (
    `<div class="event__photos-container">
      <div class="event__photos-tape">
        ${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["getMarkupFromArray"])(pictures, generatePhotoMarkup)}
      </div>
    </div>`
  );
};
...
const createEventEditTemplate = (event, destinations, offers, buttonsNames) => {
  ...
  const city = destination ? Object(he__WEBPACK_IMPORTED_MODULE_5__["encode"])(destination.name) : ``;
  const cities = destinations.map(({name}) => name);
  const allOptions = offers.get(type);
  const transferTypesMarkup = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["getMarkupFromArray"])(_const_js__WEBPACK_IMPORTED_MODULE_2__["EVENT_TYPES"].transfer, generateEventTypeElement);
  const activityTypesMarkup = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["getMarkupFromArray"])(_const_js__WEBPACK_IMPORTED_MODULE_2__["EVENT_TYPES"].activity, generateEventTypeElement);
  const citiesMarkup = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["getMarkupFromArray"])(cities, generateCitiesElement);
  const optionsMarkup = city ? generateOptionsElement(activeOptions, allOptions) : ``;
  const infoMarkup = generateInfoElement(destination);
  const typePlaceHolder = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["makeFirstLetterUppercase"])(type);
  const typeArticle = _const_js__WEBPACK_IMPORTED_MODULE_2__["EVENT_TYPES"].transfer.indexOf(type) > 0 ? `to` : `at`;

  const startTime = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["getFormatDate"])(start, `/`) + ` ` + Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["getFormatTime"])(start);
  const endTime = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["getFormatDate"])(end, `/`) + ` ` + Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_3__["getFormatTime"])(end);
...
class EventEdit extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  getData() {
    ...
    return _models_event_js__WEBPACK_IMPORTED_MODULE_1__["default"].parseEvent(newData);
  }
  ...
  _applyFlatpickr() {
    ...
    this._flatpickr = flatpickr__WEBPACK_IMPORTED_MODULE_4___default()(startDateElement, {
      altInput: true,
      altFormat: `y/m/d H:i`,
      enableTime: true,
      allowInput: true,
    ...
    this._flatpickr = flatpickr__WEBPACK_IMPORTED_MODULE_4___default()(endDateElement, {
      altInput: true,
      enableTime: true,
      altFormat: `y/m/d H:i`,
      allowInput: true,
...
const createEventTemplate = (event) => {
  ...
  const city = destination ? Object(he__WEBPACK_IMPORTED_MODULE_3__["encode"])(destination.name) : ``;
  const offersMarkup = city ? generateOptionsMarkup(options) : ``;
  const startDateTime = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getFormatDate"])(start, `-`);
  const startTime = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getFormatTime"])(start);
  const endDateTime = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getFormatDate"])(end, `-`);
  const endTime = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getFormatTime"])(end);
  const duration = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getFormatDuration"])(Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getDuration"])(start, end));
  const typeArticle = _const_js__WEBPACK_IMPORTED_MODULE_2__["EVENT_TYPES"].transfer.indexOf(type) > 0 ? `to` : `at`;
  const typeTitle = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["makeFirstLetterUppercase"])(type);
...
const generateFilterMarkup = (filter) => {
  ...
  const filterTitle = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["makeFirstLetterUppercase"])(name);
...
const createFilterTemplate = (filters) => {
  const filtersMarkup = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getMarkupFromArray"])(filters, generateFilterMarkup);
...
class Info extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/***/ "./src/components/new-event-button.js":
/*!********************************************!*\
  !*** ./src/components/new-event-button.js ***!
  \********************************************/
/*! exports provided: default */
...
class NewEventButton extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
class Price extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(events) {
    super();
...
const calculatePeriod = (events) => {
  const start = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getMonthDate"])(events[0].start);
  const end = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getMonthDate"])(events[events.length - 1].end);
...
class Route extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(events) {
    super();
...
const addTypeIcon = (type) => {
  return _const_js__WEBPACK_IMPORTED_MODULE_4__["TypeToIcon"][type] + ` ` + type;
};
...
const renderMoneyChart = (moneyCtx, statistics, types) => {
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_1___default.a(moneyCtx, {
...
const renderTransportChart = (transportCtx, statistics, transportTypes) => {
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_1___default.a(transportCtx, {
    plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_2___default.a],
    type: `horizontalBar`,
    data: {
...
const renderTimeSpentChart = (timeSpendCtx, statistics, types) => {
  ...
  types.forEach((type) => {
    const typeDuration = moment__WEBPACK_IMPORTED_MODULE_3___default.a.duration(statistics[type].time).asHours();
    hours.push(Math.floor(typeDuration));
    typesWithIcons.push(addTypeIcon(type));
  });

  return new chart_js__WEBPACK_IMPORTED_MODULE_1___default.a(timeSpendCtx, {
    plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_2___default.a],
    type: `horizontalBar`,
    data: {
      labels: typesWithIcons,
...
class Statistics extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _renderCharts() {
    ...
    const transportTypes = types.filter((type) => {
      return _const_js__WEBPACK_IMPORTED_MODULE_4__["EVENT_TYPES"].transfer.some((transferType) => transferType.toUpperCase() === type);
    });
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: HIDDEN_CLASS, EVENT_TYPES, FilterType, TypeToIcon */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TypeToIcon", function() { return TypeToIcon; });
const EVENT_TYPES = {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return HeaderController; });
...
/* harmony import */ var _components_route_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/route.js */ "./src/components/route.js");
/* harmony import */ var _components_price_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/price.js */ "./src/components/price.js");
...
const checkActualEvents = (events, filterType) => {
  ...
  switch (filterType) {
    case _const_js__WEBPACK_IMPORTED_MODULE_4__["FilterType"].FUTURE:
      isEventsMatch = events.some(({start}) => start.getTime() > currentTime.getTime());
      break;
    case _const_js__WEBPACK_IMPORTED_MODULE_4__["FilterType"].PAST:
      isEventsMatch = events.some(({start}) => start.getTime() < currentTime.getTime());
      break;
    case _const_js__WEBPACK_IMPORTED_MODULE_4__["FilterType"].EVERYTHING:
      isEventsMatch = true;
      break;
  }
...
class HeaderController {
  constructor(container, eventsModel) {
    ...
    this._activeFilterType = _const_js__WEBPACK_IMPORTED_MODULE_4__["FilterType"].EVERYTHING;
  }

  render() {
    const events = this._eventsModel.getAllEvents();
    const filters = Object.values(_const_js__WEBPACK_IMPORTED_MODULE_4__["FilterType"]).map((filterType) => {
      return {
        name: filterType,
    ...
    this._routeComponent = new _components_route_js__WEBPACK_IMPORTED_MODULE_1__["default"](events);
    this._priceComponent = new _components_price_js__WEBPACK_IMPORTED_MODULE_2__["default"](events);

    if (oldFilterComponent || oldRouteComponent || oldPriceComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._filterComponent, oldFilterComponent);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._routeComponent, oldRouteComponent);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._priceComponent, oldPriceComponent);
    } else {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._mainControlsElement, this._filterComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._infoElement, this._routeComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._infoElement, this._priceComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
    }
  }

  resetFilter() {
    this._onFilterChange(_const_js__WEBPACK_IMPORTED_MODULE_4__["FilterType"].EVERYTHING);
...
/*!*********************************************!*\
  !*** ./src/controllers/point-controller.js ***!
  \*********************************************/
/*! exports provided: default, Mode, EmptyEvent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _components_event_edit_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/event-edit.js */ "./src/components/event-edit.js");
/* harmony import */ var _components_event_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/event.js */ "./src/components/event.js");
...
class PointController {
  ...
  renderEvent(event, destinations, offers, mode) {
    ...
    this._eventComponent = new _components_event_js__WEBPACK_IMPORTED_MODULE_1__["default"](event);
    this._eventEditComponent = new _components_event_edit_js__WEBPACK_IMPORTED_MODULE_0__["default"](event, destinations, offers);
    ...
    this._eventEditComponent.setSubmitHandler((evt) => {
      ...
      if (this._eventEditComponent.isValid()) {
        ...
        const dataModel = _models_event_js__WEBPACK_IMPORTED_MODULE_2__["default"].clone(data);
    ...
    this._eventEditComponent.setFavoriteHandler(() => {
      const dataModel = _models_event_js__WEBPACK_IMPORTED_MODULE_2__["default"].clone(event);
    ...
    switch (mode) {
      case Mode.DEFAULT:
        if (oldEventComponent && oldEventEditComponent) {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._eventComponent, oldEventComponent);
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._eventEditComponent, oldEventEditComponent);
          this._replaceEditToEvent();
        } else {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._container, this._eventComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
          this._eventEditComponent.setButtonsText({
            saveButton: `Save`,
            deleteButton: `Delete`,
          });
      ...
      case Mode.ADDING:
        if (oldEventComponent && oldEventEditComponent) {
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(oldEventComponent);
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(oldEventEditComponent);
        }
        document.addEventListener(`keydown`, this._onEscKeyDown);
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._container, this._eventEditComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].AFTERBEGIN);
  ...
  _replaceEditToEvent() {
    ...
    if (document.contains(this._eventEditComponent.getElement())) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._eventComponent, this._eventEditComponent);
    }
...
/* harmony import */ var _components_days_container_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/days-container.js */ "./src/components/days-container.js");
/* harmony import */ var _components_day_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/day.js */ "./src/components/day.js");
...
/* harmony import */ var _components_no_events_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/no-events.js */ "./src/components/no-events.js");
/* harmony import */ var _controllers_point_controller_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../controllers/point-controller.js */ "./src/controllers/point-controller.js");
...
const getSortedEvents = (events, sortType) => {
  let sortedEvents = [];
  switch (sortType) {
    case _components_sort_js__WEBPACK_IMPORTED_MODULE_2__["SortType"].TIME_UP:
      sortedEvents = events.slice().sort((a, b) => Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_6__["getDuration"])(b.start, b.end) - Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_6__["getDuration"])(a.start, a.end));
      break;
    case _components_sort_js__WEBPACK_IMPORTED_MODULE_2__["SortType"].PRICE_UP:
...
class TripController {
  constructor(container, eventsModel, destinationsModel, optionsModel, api) {
    ...
    this._noEventsComponent = new _components_no_events_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._sortComponent = new _components_sort_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._daysContainerComponent = new _components_days_container_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
  ...
  createEvent() {
    ...
    this._creatingEvent = new _controllers_point_controller_js__WEBPACK_IMPORTED_MODULE_4__["default"](daysContainerElement, this._onDataChange, this._onViewChange);
    this._creatingEvent.renderEvent(_controllers_point_controller_js__WEBPACK_IMPORTED_MODULE_4__["EmptyEvent"], destinations, options, _controllers_point_controller_js__WEBPACK_IMPORTED_MODULE_4__["Mode"].ADDING);
  }
  ...
  render() {
    ...
    if (this._eventsModel.getAllEvents().length < 1) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(container, this._noEventsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
      return;
    }
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(container, this._daysContainerComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
  ...
  renderEventsByDays() {
    ...
    eventsByDates.forEach((day, i) => {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._daysContainerComponent.getElement(), new _components_day_js__WEBPACK_IMPORTED_MODULE_1__["default"](day[0], i + 1), _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
    });
  ...
  _renderEvents(container, events) {
    ...
    events.forEach((event) => {
      const newEvent = new _controllers_point_controller_js__WEBPACK_IMPORTED_MODULE_4__["default"](container, this._onDataChange, this._onViewChange);
      this._pointControllers.push(newEvent);
      newEvent.renderEvent(event, destinations, options, _controllers_point_controller_js__WEBPACK_IMPORTED_MODULE_4__["Mode"].DEFAULT);
    });
  }

  _renderSortedEvents(daysContainer, sortType) {
    if (sortType === _components_sort_js__WEBPACK_IMPORTED_MODULE_2__["SortType"].DEFAULT) {
      this.renderEventsByDays();
    } else {
      const sortEvents = getSortedEvents(this._eventsModel.getEvents(), sortType);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(daysContainer, new _components_day_js__WEBPACK_IMPORTED_MODULE_1__["default"](), _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
  ...
  _onDataChange(pointController, oldData, newData) {
    if (oldData === _controllers_point_controller_js__WEBPACK_IMPORTED_MODULE_4__["EmptyEvent"]) {
      this._creatingEvent = null;
      if (newData === null) {
...
/* harmony import */ var _models_destinations_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models/destinations.js */ "./src/models/destinations.js");
...
/* harmony import */ var _controllers_header_controller_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./controllers/header-controller.js */ "./src/controllers/header-controller.js");
/* harmony import */ var _components_info_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/info.js */ "./src/components/info.js");
/* harmony import */ var _components_menu_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/menu.js */ "./src/components/menu.js");
/* harmony import */ var _components_new_event_button__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/new-event-button */ "./src/components/new-event-button.js");
/* harmony import */ var _models_options_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./models/options.js */ "./src/models/options.js");
...
/* harmony import */ var _controllers_trip_controller_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./controllers/trip-controller.js */ "./src/controllers/trip-controller.js");
...
const destinationsModel = new _models_destinations_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
const optionsModel = new _models_options_js__WEBPACK_IMPORTED_MODULE_8__["default"]();
const api = new _api_api_js__WEBPACK_IMPORTED_MODULE_0__["default"](END_POINT, AUTHORIZATION);
const store = new _api_store__WEBPACK_IMPORTED_MODULE_11__["default"](window.localStorage);
...
const board = new _components_board_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
const tripController = new _controllers_trip_controller_js__WEBPACK_IMPORTED_MODULE_12__["default"](board, eventsModel, destinationsModel, optionsModel, apiWithProvider);
const menuComponent = new _components_menu_js__WEBPACK_IMPORTED_MODULE_6__["default"]();

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_13__["render"])(mainElement, board, _utils_render_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFOREEND);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_13__["render"])(mainHeaderElement, new _components_info_js__WEBPACK_IMPORTED_MODULE_5__["default"](), _utils_render_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].AFTERBEGIN);

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_13__["render"])(mainControlsElement, menuComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFOREEND);

const headerController = new _controllers_header_controller_js__WEBPACK_IMPORTED_MODULE_4__["default"](mainHeaderElement, eventsModel);

const statisticsComponent = new _components_statistics_js__WEBPACK_IMPORTED_MODULE_10__["default"](eventsModel);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_13__["render"])(mainElement, statisticsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFOREEND);
statisticsComponent.hide();

const newEventBtn = new _components_new_event_button__WEBPACK_IMPORTED_MODULE_7__["default"]();
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_13__["render"])(mainHeaderElement, newEventBtn, _utils_render_js__WEBPACK_IMPORTED_MODULE_13__["RenderPosition"].BEFOREEND);
...
menuComponent.setOnItemClickHandler((menuItem) => {
  switch (menuItem) {
    case _components_menu_js__WEBPACK_IMPORTED_MODULE_6__["MenuItem"].TABLE:
      statisticsComponent.hide();
      tripController.show();
      break;
    case _components_menu_js__WEBPACK_IMPORTED_MODULE_6__["MenuItem"].STATS:
      tripController.hide();
...
class Events {
  ...
  getEvents() {
    return Object(_utils_filter__WEBPACK_IMPORTED_MODULE_0__["getFilteredEvents"])(this._events, this._activeFilterType);
  }
  ...
  setEvents(events) {
    ...
    this._events = Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getByDateEvents"])(this._events);
  }
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: getByDateEvents, castTimeFormat, getFormatTime, getFormatDate, getRandomBoolean, getMarkupFromArray, getDuration, getDateTime, getFormatDuration, getMonthDate, makeFirstLetterUppercase */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getByDateEvents", function() { return getByDateEvents; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getMarkupFromArray", function() { return getMarkupFromArray; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "makeFirstLetterUppercase", function() { return makeFirstLetterUppercase; });
...
const getMonthDate = (date) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`MMM DD`);
};
...
const getDuration = (start, end) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(moment__WEBPACK_IMPORTED_MODULE_0___default()(end).diff(moment__WEBPACK_IMPORTED_MODULE_0___default()(start)));
};
